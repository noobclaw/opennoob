...
The Web Search Skill has been successfully implemented and integrated into OpenNoob. This skill enables Claude to perform real-time web searches using a Playwright-controlled browser, providing access to current information beyond the knowledge cutoff.
...
- Bridge Server auto-starts with OpenNoob
...
Implements real-time web search capability for OpenNoob using Playwright
