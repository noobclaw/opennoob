...
This guide walks through testing the entire Web Search Skill integration with OpenNoob.

## Prerequisites

1. OpenNoob built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with OpenNoob.

**Steps:**

1. Start OpenNoob in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of OpenNoob launch.
...
1. Open a terminal while OpenNoob is running
...
**Objective:** Verify graceful shutdown of services when OpenNoob quits.

**Steps:**

1. With OpenNoob running and searches completed, quit the application
...
1. Start OpenNoob (ensure headless is false in config)
...
- ✅ Server auto-starts with OpenNoob
