...
/**
 * Get default extension based on Feishu media type
 */
...
/**
 * Get default MIME type based on Feishu media type
 */
...
/**
 * Map Feishu message type to IMMediaType
 */
...
/**
 * Download media resources from Feishu messages
 *
 * Uses Feishu SDK im.messageResource.get API to download media files sent by users
 *
 * @param client Feishu REST client
 * @param messageId message ID
 * @param fileKey image_key or file_key
 * @param type resource type (image/file/audio/video)
...
/**
 * Clean up expired Feishu media files
